...
"en ti, y sálvame, para que pueda testificar una y otra vez mi gratitud ,por todo tu amor y amabilidad anor amor amor amor amor amor amor "\

resultado=mensaje.count("c")
print(resultado)
